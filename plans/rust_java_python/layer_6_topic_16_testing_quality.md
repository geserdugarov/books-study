...
| Python | Shaw (2021) — *CPython Internals* | Ch.16 pp. 346–363 | Benchmarking CPython: `timeit` for microbenchmarks (command-line and API), `pyperformance` for macro-benchmarks, `cProfile` for function-level profiling |
